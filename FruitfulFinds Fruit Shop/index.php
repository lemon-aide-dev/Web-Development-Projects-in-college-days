...
<body>
		<div class="head">
			<div class="top-part">
				<center>
					<!-- Hand-picked selections of local & imported fruits.  -->
					<p>Order all your favorite fruits with ease for delivery in General Trias City. <br>100% Guaranteed Fresh upon delivery.</p>
				</center>	
			</div>
			<div class="header">
				<a href="index.php"><img src="FruITfulFinds.png"></a>
				<div class="cart">
					<a href="" onclick="alert('Login first!');"><i class="las la-box" ></i>My Orders</a>
		...
		<div class="body">
			...
			?>
					...
					<div class="card">
           					<a type="submit" href="view.php?id=<?php echo $item_ID?>" ><img src="<?php echo $image?>" id="<?php echo $item_ID;?>" name="<?php echo $item_ID;?>"></a>
