...
<html>
    ...
    <body>
        ...
        <div class="container" id="inv_tbl">
                             <a class="float-end" href="index.php" style="padding-top: 2%;">
                                <button class = "but_choice" type="submit" onclick="alert('Admin Logged out');"><hover>Log out</hover></button>
                            </a>
                <h1>
                    <center>
        	...
        	<table class="table">
                <thead>
                    <tr>
                        <th>
                            <a href="insert_inventory.php">
                                <button class = "but_choice" type="submit"><hover>Add Item/s</hover></button>
                            </a>
                        </th>
                        <th>
                    </tr>
